    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card card-outline-info">
                ...
                <div class="card-body">
                    {!! Form::model($data, ['route' => ['setting.respondents.form.update', $data->id], 'method' => 'PUT']) !!}
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="answer_title[]" id="" value="{{ $item->title }}" class="form-control" required>
                                        </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="answer_score[]" id="" value="{{ $item->score }}" class="form-control" required>
                                        </div>
                                    </div>
                                    <!--/span-->
                                </div>
